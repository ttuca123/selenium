...
public class BtpSrv289SubstituicaoHidrometroParaPesquisa extends ServicoPadrao{
	...
	@Override
	public void preencherDadosBaixa(ServicoPadrao servico) throws ClassNotFoundException, SQLException {

		DriverUtils.escrever(ItemAtendimentoPage.dataRetiradaMedidor,
				DATA_ATUAL);
