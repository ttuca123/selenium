...
public class DemandaBean
{
	...
	public boolean getVerificaImportacao()
	{
		if ( btpSistema != null
				...
				&& btpSistema.getSisFlgImportacao().equals(EnumSituacaoSimNao.SIM) )
		{
			return true;
		}
		return false;
	...
	public void importar() throws Exception
	{
		...
		try
		{
			...
			preparedStatement.setLong(2, btpVersao.getBtpSistema().getSisCodSGD());
			...
			while (rs.next())
			{
				...
				demanda.setDemFlgExtra(EnumSituacaoSimNao.NAO);
	...
	public void gerarDataExecucao()
	{
		if ( (btpDemanda != null)
				...
				&& (!btpDemanda.getDemCodStatus().equals(EnumStatusDemanda.NAO_TESTADA)) )
		{
	...
	public String getResumoDemandas()
	{
		...
		texto.append(String.format("%03d", executadas + naoExecutadas + bloqueadas)
				+ " [100%]  SGDS<br/>");

		texto
				.append(String.format("%03d", aprovadas) + " ["
